...
jq -n \
  ...
  '{
    ...
    controller: {
      ...
      sourceRepo: ($ctrl.sourceRepo // "bbvinet/psc-sre-automacao-controller"),
      sourceBranch: ($ctrl.sourceBranch // "main"),
      sourceHeadSha: ($ctrl.sourceHeadSha // null),
      sourceHeadMatchesReleased: ($ctrl.sourceHeadMatchesReleased // null),
      sourceHeadCheckedAt: ($ctrl.sourceHeadCheckedAt // null),
    ...
    agent: {
      ...
      sourceRepo: ($agent.sourceRepo // "bbvinet/psc-sre-automacao-agent"),
      sourceBranch: ($agent.sourceBranch // "main"),
      sourceHeadSha: ($agent.sourceHeadSha // null),
      sourceHeadMatchesReleased: ($agent.sourceHeadMatchesReleased // null),
      sourceHeadCheckedAt: ($agent.sourceHeadCheckedAt // null),
